            ...
            <div class="col-2">
                <div id='cssmenu'>
                    <ul>
                        ...
                        <li>
                            <a href="dispatched-products.jsp" target="_self" class="active"><img src="images/closet.png" alt="Dispatch Clothe" width="50px" height="50px"><br><p>See Dispatched Products</p></a>
                        </li>
                        <li>
            ...
            <%
                ...
                try {
                    ...
                    PreparedStatement ps = con.prepareStatement("SELECT customer.customerID, "
                            ...
                            + "spID = ? AND customer_service.status = 'dispatched'");
                    ...
                    if(list.size() == 0){
                        out.println("<h1>No Dispatched Products...</h1>");}
                    else{
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        <form method='POST' action='return-product.jsp?serviceID=<%=i%>'>
