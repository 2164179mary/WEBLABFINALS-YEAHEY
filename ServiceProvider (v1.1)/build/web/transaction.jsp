        ...
        <div class="content">
            <div class="col-2">
                <div id='cssmenu'>
                    <ul>
                        ...
                        <li>
                            <a href="transaction.jsp" target="_self" class="active"><img src="images/transactions.png" alt="Transaction" width="50px" height="50px"><br><p>Transaction Monitoring</p></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            try {
                ...
                PreparedStatement ps = con.prepareStatement("SELECT customer.customerID, "
                        ...
                        + "spID = ? AND customer_service.status != 'denied'");
                ...
                if(list.size() == 0){
                    out.println("<h1>No Transactions...</h1>");}
                else{
